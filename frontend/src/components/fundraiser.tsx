...
const Fundraiser: React.FC = () => {
    ...
    return (
             <div className='bg-grey px-5 py-12 w-full'>
                ...
                <div className='flex flex-row'>
                    ...
                    <div className='w-1/2 mx-2'>
                        ...
                        <h1 className='italic mt-12 xl:mt-16 font-semibold text-lg '>Wednesday July 24 | South Lyon Hotel | 6pm est </h1>
                ...
                <div className='flex items-center flex-col'>
                    ...
                    <img src='/images/dmcc.jpeg' alt='DMAC' className='w-1/2 h-auto'/>
                        ...
                        <h1 className='uppercase text-xl font-bold text-blue sm:text-3xl'>Darren McCarty's Comedy & Dinner Fundraiser</h1>
                        <a href='https://www.eventbrite.com/e/darren-mccartys-comedy-dinner-fundraiser-for-brian-clark-for-supervisor-tickets-936482954727?aff=ebdsoporgprofile' target='_blank' rel='noopener noreferrer'>
                        <button className='py-2 px-3 mt-5 text-lg bg-black text-white'>PURCHASE TICKETS</button></a>
                        <h1 className='italic mt-6 xl:mt-16 font-semibold text-md'>Wednesday July 24 | South Lyon Hotel | 6pm est </h1>
                        </div>
