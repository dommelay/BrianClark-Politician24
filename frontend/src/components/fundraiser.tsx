             ...
             <div className='bg-grey px-10 py-12 w-full'>
                <div className='flex flex-row'>
                    ...
                    <div className='w-1/2 mx-10'>
                        <h1 className='uppercase font-bold text-blue text-4xl'>Darren McCarty's Comedy & Dinner Fundraiser</h1>
                        ...
                        <button className='py-2 px-4 mt-10 text-2xl bg-black text-white'>PURCHASE TICKETS</button></a>
                        <h1 className='mt-12 font-semibold text-2xl'>Wednesday July 24 | South Lyon Hotel | 6pm est </h1>
