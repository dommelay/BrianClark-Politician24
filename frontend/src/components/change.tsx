    ...
    return (
        <div className='px-10 py-10'>
                <div className='flex flex-col justify-center'>
                    <h1 className='md:mb-2 font-bold text-xl md:text-2xl lg:text-4xl'>The Change Thats Coming:</h1>
                ...
                <img className='w-full px-4 lg:px-0 mt-2 lg:order-1 lg:w-1/2 ' src='/images/pray.jpg' alt='change'/>
                    <div className='lg:mr-8 '>
                        <p className='m-3 md:text-left font-semibold  lg:text-lg xl:text-xl'>This misrepresentation undermines the trust of our residents. My mission will be to restore faith and integrity in our office, ensuring residents know we are here to serve them. To achieve this, I will:</p>
