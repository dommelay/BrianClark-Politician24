    ...
    return (
        ...
        <div id='nav' className="bg-blue h-12 md:h-16 flex items-center sticky top-0 z-50">
            ...
            <div className="flex flex-row ml-auto">
                <Link to="purpose" smooth={true} duration={500} className="mr-2 sm:mr-4 text-white font-semibold text-base md:text-lg lg:text-xl cursor-pointer hover:underline" offset={handleOffset()}>Purpose</Link>
                <Link to="plan" smooth={true} duration={500} className="mr-2 sm:mr-4 text-white font-semibold text-base md:text-lg lg:text-xl cursor-pointer hover:underline" offset={handleOffset()}>Plan</Link>
