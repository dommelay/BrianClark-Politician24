...
const PhotoCarousel: React.FC = () => {
    ...
    return (
        ...
        <div className=' mb-10 flex flex-col items-center justify-center p-12'>
            <h1 className='font-bold text-4xl md:text-6xl italic text-blue mb-10'>Meet My Family</h1>
            <div className="flex overflow-x-auto space-x-4 h-2/3 sm:h-96 md:h-512">
